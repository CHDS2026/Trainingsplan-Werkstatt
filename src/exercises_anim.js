...
const MAP = {
  squat_lh:"squat", zombiesquat:"squat", frontsquat:"squat", gobletsquat:"squat", hacksquat:"squat", pausesquat:"squat", overheadsquat:"squat",
  bench_lh:"bench", cableflys:"bench", smith_flat:"bench", smith_incl:"bench", bench_kh:"bench", incline_lh:"bench", incline_kh:"bench", incline_m:"bench", chestpress_m:"bench", chestpress_c:"bench",
  deadlift:"hinge", rdl_lh:"hinge", rdl_kh:"hinge", goodmorning:"hinge",
  ohp_lh:"ohp", ohp_kh:"ohp", ohp_m:"ohp", pushpress:"ohp",
  row_lh:"row", revfly_c:"row", row_x:"row", row_kh:"row", row_c:"row", bodyrow:"row", row_m:"row", row_tbar:"row",
  pullup:"pull", weightedpull:"pull", chinup:"pull", neutralpullup:"pull", pulldown_w:"pull", pulldown_c:"pull",
