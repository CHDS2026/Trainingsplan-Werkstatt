  ...
  const buildExamplePlan=()=>{
    ...
    return {weeks:8,days:[
      ...
      {id:uid(),name:"Sonntag · Squat (schwer)",warmup:wu(),main:[
        ...
        {id:"lunges",sets:3,reps:10,kg:22.5},
        {id:"legext",sets:3,reps:12,kg:50},
        {id:"legcurl_s",sets:3,reps:12,kg:45}],cooldown:[{id:"jogging",min:35}]},
      ...
      {id:uid(),name:"Dienstag · Pull (Rücken)",warmup:wu(),main:[
        ...
        {id:"pulldown_w",sets:3,reps:10,kg:70},
        {id:"curl_kh",sets:3,reps:12,kg:15}],cooldown:[{id:"bike_erg",min:40}]},
      // Mittwoch – Deadlift (schwer) + hintere Kette
      {id:uid(),name:"Mittwoch · Deadlift (schwer)",warmup:wu(),main:[
      ...
      // Donnerstag – Push (OHP) + Arme
      {id:uid(),name:"Donnerstag · Push / OHP",warmup:wu(),main:[
        {id:"ohp_lh",sets:4,reps:5,kg:60},
        {id:"cgbench",sets:4,reps:8,kg:92.5},
        {id:"dips",sets:3,reps:8,kg:0},
