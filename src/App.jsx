...
export default function App(){
  ...
  const addCustomEx=(dayId,section,exId)=>{const entry=section==="main"?{id:exId,sets:4,reps:8}:{id:exId,min:5};setCustomPlan((c)=>({...c,days:c.days.map((d)=>d.id===dayId?{...d,[section]:[...d[section],entry]}:d)}));setAdding(null);setExQuery("");};
  ...
  const buildExamplePlan=()=>{
    const wu=()=>[
      {id:"Seilspringen + Foam Rolling",min:8},
    ...
    return {weeks:8,days:[
      ...
      {id:uid(),name:"Sonntag · Squat & Recovery",warmup:wu(),main:[
        {id:"squat_lh",sets:4,reps:5}],cooldown:[{id:"jogging",min:35}]},
      ...
      {id:uid(),name:"Dienstag · Pull & Cardio",warmup:wu(),main:[
        ...
        {id:"curl_kh",sets:3,reps:12}],cooldown:[{id:"bike_erg",min:40}]},
