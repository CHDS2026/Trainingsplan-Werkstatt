...
export default function App(){
  ...
  const tryMasterCode=(v)=>{ setMasterCode(v); if(v.trim().toLowerCase()==="dane")setMasterOpen(true); };
  ...
  const buildMasterPlan=()=>{
    ...
    return {weeks:8,days:[
      {id:uid(),name:"Montag · Squat (schwer) & Beine",warmup:wu(),main:[
        {id:"squat_lh",sets:4,reps:5,kg:97.5},
        {id:"frontsquat",sets:3,reps:8,kg:65},
        {id:"rdl_lh",sets:3,reps:8,kg:100}],cooldown:cd([{id:"jogging",min:35}])},
      {id:uid(),name:"Dienstag · Pull (Low CNS) & Cardio",warmup:wu(),main:[
        {id:"handstand",sets:1,reps:10,kg:0},
        {id:"pulldown_w",sets:4,reps:13,kg:70},
        {id:"row_c",sets:3,reps:13,kg:60},
        {id:"curl_c",sets:3,reps:13,kg:30}],cooldown:cd([{id:"bike_erg",min:40}])},
      {id:uid(),name:"Mittwoch · Push (Volumen) & OHP",warmup:wu(),main:[
        {id:"ohp_lh",sets:4,reps:5,kg:60},
        {id:"cgbench",sets:4,reps:8,kg:90},
        {id:"ringdips",sets:4,reps:10,kg:0},
        {id:"triceps_c",sets:3,reps:13,kg:25}],cooldown:cd()},
      {id:uid(),name:"Donnerstag · Deadlift (schwer) & Levers",warmup:wu(),main:[
        {id:"frontlever",sets:5,reps:8,kg:0},
        {id:"deadlift",sets:3,reps:3,kg:137.5},
        {id:"weightedpull",sets:4,reps:7,kg:10},
        {id:"calf_st",sets:3,reps:15,kg:60}],cooldown:cd()},
      {id:uid(),name:"Freitag · PAUSE (komplette Regeneration)",warmup:[],main:[],cooldown:[]},
      {id:uid(),name:"Samstag · Bench (schwer) & Planche",warmup:wu(),main:[
        {id:"planche",sets:5,reps:10,kg:0},
        {id:"bench_lh",sets:4,reps:5,kg:117.5},
        {id:"row_lh",sets:4,reps:8,kg:80},
        {id:"latraise_c",sets:3,reps:13,kg:12},
        {id:"facepull",sets:3,reps:15,kg:20}],cooldown:cd()},
      {id:uid(),name:"Sonntag · Calisthenics & Obere Brust",warmup:wu(),main:[
        {id:"muscleup",sets:4,reps:5,kg:0},
        {id:"oap",sets:4,reps:4,kg:0},
        {id:"smith_incl",sets:4,reps:13,kg:40},
        {id:"bodyrow",sets:4,reps:12,kg:0},
        {id:"lsit",sets:3,reps:12,kg:0}],cooldown:cd()},
    ]};
  };
      ...
      {tab==="data"&&(<section style={S.card}>
        ...
        <div style={{marginTop:26,paddingTop:16,borderTop:`1px solid ${LINE}`}}>
          ...
          {!masterOpen?(
            ...
            <div style={{fontSize:12.5,color:CHALK,marginBottom:10}}>Master-Plan freigeschaltet.</div>
            <button onClick={loadMaster} style={{...cta(false)}}>Master-Trainingsplan laden</button>
            <div style={{...S.hint,marginTop:8}}>Lädt den kompletten 6-Tage-Master-Plan als deinen eigenen Plan (überschreibt den aktuellen).</div>
          </>)}
        </div>
      </section>)}
