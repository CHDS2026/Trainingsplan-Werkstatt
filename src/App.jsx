...
export default function App(){
  ...
  const buildMasterPlan=()=>{
    ...
    return {weeks:8,days:[
      ...
      {id:uid(),name:"Tag B · Squat & Lower Body",warmup:wu(),main:[
      ...
      {id:uid(),name:"Tag D · Deadlift & Lever",warmup:wu(),main:[
        {id:"frontlever",sets:4,reps:8,kg:0},
        {id:"deadlift",sets:3,reps:3,kg:137.5},
        {id:"zombiesquat",sets:4,reps:8,kg:50},
        {id:"calf_st",sets:3,reps:15,kg:60}],cooldown:cd([{id:"bike_erg",min:25}])},
      ...
      {id:uid(),name:"Tag F · Pull & Muscle-Ups",warmup:wu(),main:[
        ...
        {id:"weightedpull",sets:5,reps:5,kg:10},
        {id:"row_x",sets:3,reps:12,kg:55}],cooldown:cd([{id:"bike_erg",min:30}])},
