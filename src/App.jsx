...
export default function App(){
  ...
  const buildMasterPlan=()=>{
    const wu=()=>[
      {id:"Seilspringen / leichtes Cardio",min:5},
      {id:"Scapular Prep: 2×15 Push-ups / 2×15 Pull-ups / 2×12 Dips",min:5},
      {id:"Dyn. Mobilisation: Schultern / Handgelenke / Hüfte",min:4},
    ];
    const cd=(extra)=>[
      {id:"Statisches Dehnen der Tages-Zielmuskeln",min:5},
      {id:"Seilspringen",min:5},
      ...(extra||[]),
    ];
    return {source:"dane",version:PLAN_VERSION,weeks:8,days:[
      {id:"dane-c",name:"Tag C · OHP & OAPU",warmup:wu(),main:[
        ...
        {id:"pulldown_x",sets:4,reps:8,kg:65},
      ...
      {id:"dane-b",name:"Tag B · Squat & Legs",warmup:wu(),main:[
        ...
        {id:"plank",sets:3,reps:1,kg:0},
        {id:"deadhang",sets:3,reps:1,kg:0},
        {id:"bulgarian",sets:3,reps:9,kg:22.5},
        {id:"wallsit",sets:3,reps:1,kg:0}],cooldown:cd()},
