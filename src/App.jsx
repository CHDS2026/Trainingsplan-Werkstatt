...
export default function App(){
  ...
  const buildMasterPlan=()=>{
    ...
    const cd=(extra)=>[
      {id:"Aktiv: Gehen / Radfahren (leicht)",min:4},
      {id:"Statisches Dehnen der Tages-Zielmuskeln",min:5},
      {id:"Bauchatmung Rücken, Beine hoch",min:3},
      ...(extra||[]),
    ];
    return {weeks:8,days:[
      {id:uid(),name:"Tag C · OHP & OAPU",warmup:wu(),main:[
        ...
        {id:"curl_c",sets:3,reps:15,kg:30}],cooldown:cd([{id:"Dead Hangs (Aushängen)",min:3}])},
      {id:uid(),name:"Tag D · Deadlift & Lower Body",warmup:wu(),main:[
        {id:"frontlever",sets:4,reps:8,kg:0},
        {id:"deadlift",sets:3,reps:3,kg:137.5},
        {id:"zombiesquat",sets:4,reps:8,kg:50},
        {id:"calf_st",sets:3,reps:15,kg:60}],cooldown:cd([{id:"bike_erg",min:20}])},
      {id:uid(),name:"Tag E · Dips, Chest & Handstand",warmup:wu(),main:[
        ...
        {id:"yraise",sets:3,reps:15,kg:7.5}],cooldown:cd([{id:"Dead Hangs (Aushängen)",min:3}])},
      {id:uid(),name:"Tag F · Pull & Muscle-Ups",warmup:wu(),main:[
        ...
        {id:"hammercurl",sets:3,reps:13,kg:14}],cooldown:cd([{id:"bike_erg",min:20}])},
      ...
      {id:uid(),name:"Tag A · Bench & Planche",warmup:wu(),main:[
        ...
        {id:"facepull",sets:3,reps:15,kg:20}],cooldown:cd([{id:"Dead Hangs (Aushängen)",min:3}])},
      {id:uid(),name:"Tag B · Squat & Legs",warmup:wu(),main:[
        ...
        {id:"bulgarian",sets:3,reps:9,kg:22.5}],cooldown:cd([{id:"bike_erg",min:20}])},
      ...
      {nextSession&&(<section style={S.nextCard}>
        ...
        <div style={{marginTop:9}}>
          {nextSession.items.slice(0,6).map((it,i)=>{const ex=EXERCISES.find((e)=>e.id===it.id);const nm=ex?ex.name:(it.name||it.id);
            const detail=nextSession.source==="custom"?(isSkill(it.id)?"Skill":`${it.sets}×${it.reps}${it.kg?` · ${it.kg} kg`:""}`):`${it.s||""}${it.w?` · ${it.w}`:""}`;
