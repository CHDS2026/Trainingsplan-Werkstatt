  ...
  const buildExamplePlan=()=>{
    ...
    return {weeks:8,days:[
      {id:uid(),name:"Samstag · Bench & Planche",warmup:wu(),main:[
        {id:"planche",sets:5,reps:10,kg:0},{id:"bench_lh",sets:4,reps:5,kg:117.5},{id:"row_lh",sets:4,reps:8,kg:80},
        {id:"latraise_c",sets:3,reps:12,kg:12},{id:"facepull",sets:3,reps:18,kg:20}],cooldown:[]},
      {id:uid(),name:"Sonntag · Squat & Recovery",warmup:wu(),main:[
        {id:"squat_lh",sets:4,reps:5,kg:97.5}],cooldown:[{id:"jogging",min:35}]},
      {id:uid(),name:"Montag · Calisthenics",warmup:wu(),main:[
        {id:"muscleup",sets:5,reps:5,kg:0},{id:"oap",sets:3,reps:4,kg:0},{id:"ringdips",sets:4,reps:10,kg:0},
        {id:"lsit",sets:3,reps:12,kg:0}],cooldown:[]},
      {id:uid(),name:"Dienstag · Pull & Cardio",warmup:wu(),main:[
        {id:"handstand",sets:1,reps:10,kg:0},{id:"pulldown_w",sets:4,reps:10,kg:70},{id:"row_c",sets:3,reps:11,kg:60},
        {id:"curl_kh",sets:3,reps:12,kg:15}],cooldown:[{id:"bike_erg",min:40}]},
      {id:uid(),name:"Mittwoch · Deadlift & Levers",warmup:wu(),main:[
        {id:"frontlever",sets:5,reps:8,kg:0},{id:"deadlift",sets:3,reps:3,kg:137.5},{id:"weightedpull",sets:4,reps:7,kg:10},
        {id:"calf_st",sets:3,reps:15,kg:60}],cooldown:[]},
      {id:uid(),name:"Donnerstag · Push / OHP",warmup:wu(),main:[
        {id:"ohp_lh",sets:4,reps:5,kg:60},{id:"cgbench",sets:4,reps:8,kg:92.5},{id:"dips",sets:4,reps:8,kg:0},
