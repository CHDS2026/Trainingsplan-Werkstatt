...
export default function App(){
  ...
  const loadMaster=()=>{ if(customPlan&&!confirm("Master-Plan laden? Dein aktueller eigener Plan wird ersetzt."))return;
    setCustomPlan(buildMasterPlan()); setCustomLog({}); setDoneLog({}); setFocusDay(null); setEditWeek(1); setCWeek(1); setTab("track");
  ...
  const loadGulnaz=()=>{ if(customPlan&&!confirm("Plan Gülnaz laden? Dein aktueller eigener Plan wird ersetzt."))return;
    setCustomPlan(buildGulnazPlan()); setCustomLog({}); setDoneLog({}); setFocusDay(null); setEditWeek(1); setCWeek(1); setTab("track");
