...
export default function App(){
  ...
  const mutateFrom=(week,fn)=>setCustomPlan((c)=>{ if(!c)return c;
    if(week<=1&&!(c.revs||[]).some((r)=>r.fromWeek===1)) return {...c,days:fn(deep(c.days))};
    return {...c,revs:upsertRev([...(c.revs||[])],week,fn(deep(daysForWeek(c,week))))};});
  ...
  const buildMasterPlan=()=>{
    ...
    return {source:"dane",weeks:8,days:[
  ...
  const buildGulnazPlan=()=>{
    ...
    return {source:"gulnaz",weeks:8,days:[
