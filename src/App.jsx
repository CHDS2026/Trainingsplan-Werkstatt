...
const S={
  ...
  revBox:{background:"#FBF7F0",border:`1.5px solid ${LINE}`,borderRadius:10,padding:12,marginBottom:12},
  revRow:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"4px 0",borderBottom:`1px solid ${LINE}`},
  nextCard:{background:"#FFF",border:`2px solid ${RUST}`,borderRadius:12,padding:"14px 16px",marginBottom:14},
  nextWhen:{display:"inline-block",padding:"3px 10px",borderRadius:999,background:RUST,color:"#fff",fontSize:11,fontWeight:800,letterSpacing:".03em"},
  ...
  dragHandle:{fontSize:17,color:"#C8BBAA",cursor:"grab",touchAction:"none",userSelect:"none",WebkitUserSelect:"none",padding:"0 4px",lineHeight:1.2,flexShrink:0},
