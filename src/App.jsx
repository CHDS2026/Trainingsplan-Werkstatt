...
export default function App(){
  ...
  useEffect(()=>{ if(!hydrated)return; saveState({focuses,planWeeks,daysPerWeek,recovery,expL,budget,week,bw,height,bodyfat,activity,oneRM,picked,equip,injuries,track,history,ratings,weightLog,customPlan,customLog,doneLog,setupDone}); },
    [hydrated,focuses,planWeeks,daysPerWeek,recovery,expL,budget,week,bw,height,bodyfat,activity,oneRM,picked,equip,injuries,track,history,ratings,weightLog,customPlan,customLog,doneLog,setupDone]);
  ...
  stateRef.current={focuses,planWeeks,daysPerWeek,recovery,expL,budget,week,bw,height,bodyfat,activity,oneRM,picked,equip,injuries,track,history,ratings,weightLog,customPlan,customLog,doneLog,setupDone};
